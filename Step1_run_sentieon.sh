...
## Usage: ./Step1_run_sentieon.sh myConfigFile.config
...
mkdir -p ${outputFolderPath}/01_SNV_sample_level || exit 1
...
do
	...
	### Step 2: Calculate data metrics (Optional)
