...
## Usage: ./Step3_QC.sh myConfigFile.config
...
RunFolderPath=${outputFolderPath}/02_SNV/02_QC

# log
logfile=${RunFolderPath}/QC.log
exec >$logfile 2>&1

# =============================================================================
#                           Run QC Pipeline
# =============================================================================
mkdir ${RunFolderPath}/01_plink
cd ${RunFolderPath}/01_plink

cohort_plink=${outputFolderPath}/02_SNV/01_joint_calling/03_change_format/02_plink/cohort_v3

### [1] Missingness ###
plink --bfile $cohort_plink --geno 0.05 --make-bed --out 01_Missingness_1
